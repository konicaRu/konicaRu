...
<h4> Я делаю, поддерживаю и анализирую отчеты, сводные таблицы и дашбордах, использую Excel, Power Query, Power Pivot, DAX, язык M , Access. Выгружаю данные с помощью SQL<br> 
