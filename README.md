...
<h4> Я делаю, поддерживаю и анализирую отчеты, сводные таблицы и дашборды. Мой стек: Excel, Power Query, Power Pivot, DAX, язык M , Access. Python (numpy/pandas/plotly/matplotlib/scikit-learn/ seaborn/requests/ BeautifulSoup/SciPy). Выгружаю данные с помощью SQL <br>  
